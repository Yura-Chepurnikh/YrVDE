...
QT_MOC_LITERAL(1, 8, 15), // "createLogicGate"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10), // "LogicGate*"
QT_MOC_LITERAL(4, 36, 4) // "gate"

    },
    "ToolBar\0createLogicGate\0\0LogicGate*\0"
    "gate"
};
...
void ToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->createLogicGate((*reinterpret_cast< LogicGate*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ToolBar::*)(LogicGate * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToolBar::createLogicGate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ToolBar::createLogicGate(LogicGate * _t1)
{
